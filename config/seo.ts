export const siteConfig = {
  ...
  keywords: [
    "synchroniser stocks B2B",
    "synchronisation stocks mode",
    "synchroniser prix plateformes",
    "synchronisation commandes B2B",
    "éviter survente stocks",
    "synchronisation temps réel",
    "synchroniser shopify faire",
    "synchroniser ankorstore shopify",
    "synchroniser PFS microstore",
    "centralisation commandes B2B",
    "synchronisation automatique stocks",
    "grossiste synchronisation prix",
    "paris fashion shops synchronisation",
    "microstore synchroniser commandes",
  ],
};
